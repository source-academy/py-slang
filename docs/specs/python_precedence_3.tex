...
\begin{center}
  \begin{tabular}{l|l|c}
    ...
    \textbf{\texttt{in}}, \textbf{\texttt{not in}}, \textbf{\texttt{is}}, \textbf{\texttt{is not}} & membership, identity & n/a \\
...
\item Since \texttt{\textbf{**}} binds more tightly than unary
  ...
  \texttt{\textbf{(-2) ** 2}}.
\item Comparison, membership and identity operators are non-associative:
  unlike full Python, where e.g.\ \texttt{\textbf{a < b < c}} is
  equivalent to \texttt{\textbf{a < b and b < c}} (evaluating
  \texttt{\textbf{b}} once and short-circuiting before
  \texttt{\textbf{c}} is reached), this grammar gives every one of these
  operators exactly two operands. Chaining any of them, or mixing
  different ones as in \texttt{\textbf{a < b == c}}, is therefore
  rejected outright as a syntax error --- a deliberate sublanguage
  restriction, rather than giving chained comparisons some other,
