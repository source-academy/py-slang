...
&& \textit{statement}    &&\quad ::= &\quad && \textit{name} \ \textbf{\texttt{=}}\ \textit{expression}
                                                           && \textrm{variable declaration, assignment} \\
...
&&                       && |   &\quad && \textbf{\texttt{for}}\ \textit{name}\ \textbf{\texttt{in range(}}\ \textit{range-args}\ \textbf{\texttt{)}}\ \textbf{\texttt{:}}\ \textit{block}\ \ 
                                                           && \textrm{for loop}\\
&&                       && |   &\quad &&  \textbf{\texttt{nonlocal}}\ \textit{name}
                                                           && \textrm{nonlocal statement}\\
&&                       && |   &\quad &&  \textit{expression}
                                                           && \textrm{expression statement} \\[1mm]
% &&                       && |   &\quad &&  \textbf{\texttt{debugger()}}
%                                                            && \textrm{breakpoint} \\[1mm]
&& \textit{range-args}   && ::= &\quad && \textit{expression}\ [\ \textbf{\texttt{,}} \ \textit{expression}\ ]\ [\ \textbf{\texttt{,}} \ \textit{expression}\ ]               && \textrm{for loop range arguments}\\
&& \textit{rest-names}   && ::= &\quad &&  \epsilon\ | \ \textbf{\texttt{*}}\textit{name}\ |\ \textit{name} \ 
(\ \textbf{\texttt{,}} \ \textit{name}\ ) ...\ [\ \textbf{\texttt{, *}}\textit{name}\ ]
                                                           && \textrm{name list (rest)}   \\[1mm]
...
&&                       && |   &\quad &&  \textbf{\texttt{None}} 
                                                           && \textrm{primitive linked list expression}\\
...
&&                       && |   &\quad &&   \textbf{\texttt{lambda}}\ (\ \textit{name}\ | \ \textit{names}\ )\    
