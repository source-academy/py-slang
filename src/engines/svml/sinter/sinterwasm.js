var sinterwasm = (() => {
  ...
  return async function (moduleArg = {}) {
    ...
    function assignWasmExports(wasmExports) {
      Module["_siwasm_alloc_heap"] = _siwasm_alloc_heap = wasmExports["l"];
      Module["_siwasm_alloc"] = _siwasm_alloc = wasmExports["m"];
      Module["_siwasm_free"] = _siwasm_free = wasmExports["n"];
      Module["_siwasm_run"] = _siwasm_run = wasmExports["o"];
      _setThrew = wasmExports["q"];
      __emscripten_stack_restore = wasmExports["r"];
      __emscripten_stack_alloc = wasmExports["s"];
      _emscripten_stack_get_current = wasmExports["t"];
    }
    var wasmImports = {
      a: ___assert_fail,
