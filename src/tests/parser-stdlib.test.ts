...
describe("Parser Stdlib Tests", () => {
  ...
  generateNativePyinterTestCases(literalTests, 4);
  generateNativePyinterTestCases(nameTests, 4);
  generateNativePyinterTestCases(binaryTests, 4);
  generateNativePyinterTestCases(unaryTests, 4);
  generateNativePyinterTestCases(boolOpTests, 4);
  generateNativePyinterTestCases(compareTests, 4);
  generateNativePyinterTestCases(conditionalTests, 4);
  generateNativePyinterTestCases(loopTests, 4);
  generateNativePyinterTestCases(functionTests, 4);
  generateNativePyinterTestCases(lambdaTests, 4);
  generateNativePyinterTestCases(applicationTests, 4);
  generateNativePyinterTestCases(assignTests, 4);
  generateNativePyinterTestCases(listTests, 4);
  generateNativePyinterTestCases(starredTests, 4);
  generateNativePyinterTestCases(controlFlowTests, 4);
  generateNativePyinterTestCases(scopeTests, 4);
  generateNativePyinterTestCases(assertTests, 4);
  generateNativePyinterTestCases(importTests, 4);
  generateNativePyinterTestCases(sequenceTests, 4);
  generateNativePyinterTestCases(nestedTests, 4);
  generateNativePyinterTestCases(parseErrorTests, 4);
  generateNativePyinterTestCases(tokenizeTests, 4);
  generateNativePyinterTestCases(applyTests, 4);
});
