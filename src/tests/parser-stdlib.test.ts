...
describe("Parser Stdlib Tests", () => {
  ...
  const literalTests: TestCases = {
    ...
    "parse — float literal": [
      ['print(parse("3.14"))', null, ["['literal', [3.14, None]]"]],
    ],
    ...
    "parse — None literal": [
      ['print(parse("None"))', null, ["['literal', [None, None]]"]],
    ],
    ...
    "parse — complex literal": [
      ['print(parse("3j"))', null, ["['literal', [3j, None]]"]],
    ],
    "parse — complex expression": [
      ['print(parse("2+3j"))', null, ["[ 'binary_operator_combination',\n['+', [['literal', [2, None]], [['literal', [3j, None]], None]]]]"]],
    ],
  };
  ...
  const binaryTests: TestCases = {
    "parse — arithmetic operators": [
      ['print(parse("1 + 2"))', null, ["[ 'binary_operator_combination',\n['+', [['literal', [1, None]], [['literal', [2, None]], None]]]]"]],
      ['print(parse("3 - 1"))', null, ["[ 'binary_operator_combination',\n['-', [['literal', [3, None]], [['literal', [1, None]], None]]]]"]],
      ['print(parse("2 * 3"))', null, ["[ 'binary_operator_combination',\n['*', [['literal', [2, None]], [['literal', [3, None]], None]]]]"]],
      ['print(parse("6 / 2"))', null, ["[ 'binary_operator_combination',\n['/', [['literal', [6, None]], [['literal', [2, None]], None]]]]"]],
      ['print(parse("7 // 3"))', null, ["[ 'binary_operator_combination',\n['//', [['literal', [7, None]], [['literal', [3, None]], None]]]]"]],
      ['print(parse("7 % 3"))', null, ["[ 'binary_operator_combination',\n['%', [['literal', [7, None]], [['literal', [3, None]], None]]]]"]],
      ['print(parse("2 ** 3"))', null, ["[ 'binary_operator_combination',\n['**', [['literal', [2, None]], [['literal', [3, None]], None]]]]"]],
    ],
  };
  ...
  const unaryTests: TestCases = {
    "parse — unary operators": [
      ['print(parse("-1"))', null, ["['unary_operator_combination', ['-', [['literal', [1, None]], None]]]"]],
      ['print(parse("not True"))', null, ["['unary_operator_combination', ['not', [['literal', [True, None]], None]]]"]],
    ],
  };
  ...
  const boolOpTests: TestCases = {
    "parse — logical composition": [
      ['print(parse("True and False"))', null, ["[ 'logical_composition',\n['and', [['literal', [True, None]], [['literal', [False, None]], None]]]]"]],
      ['print(parse("True or False"))', null, ["[ 'logical_composition',\n['or', [['literal', [True, None]], [['literal', [False, None]], None]]]]"]],
    ],
  };
  ...
  const compareTests: TestCases = {
    "parse — comparison operators": [
      ['print(parse("1 == 2"))', null, ["['comparison', ['==', [['literal', [1, None]], [['literal', [2, None]], None]]]]"]],
      ['print(parse("1 != 2"))', null, ["['comparison', ['!=', [['literal', [1, None]], [['literal', [2, None]], None]]]]"]],
      ['print(parse("1 < 2"))', null, ["['comparison', ['<', [['literal', [1, None]], [['literal', [2, None]], None]]]]"]],
      ['print(parse("1 <= 2"))', null, ["['comparison', ['<=', [['literal', [1, None]], [['literal', [2, None]], None]]]]"]],
      ['print(parse("1 > 2"))', null, ["['comparison', ['>', [['literal', [1, None]], [['literal', [2, None]], None]]]]"]],
  ...
  const conditionalTests: TestCases = {
    "parse — conditional statement (if/else)": [
      ['print(parse("if True:\\n    1\\nelse:\\n    2\\n"))', null, ["[ 'conditional_statement',\n[ ['literal', [True, None]],\n[['literal', [1, None]], [['literal', [2, None]], None]]]]"]],
    ],
    "parse — conditional expression (ternary)": [
      ['print(parse("1 if True else 2"))', null, ["[ 'conditional_expression',\n[ ['literal', [True, None]],\n[['literal', [1, None]], [['literal', [2, None]], None]]]]"]],
    ],
  };
  ...
  const loopTests: TestCases = {
    "parse — while loop": [
      ['print(parse("while True:\\n    pass\\n"))', null, ["['while_loop', [['literal', [True, None]], [['pass_statement', None], None]]]"]],
    ],
    "parse — while with break": [
      ['print(parse("while True:\\n    break\\n"))', null, ["['while_loop', [['literal', [True, None]], [['break_statement', None], None]]]"]],
    ],
    "parse — while with continue": [
      ['print(parse("while True:\\n    continue\\n"))', null, ["['while_loop', [['literal', [True, None]], [['continue_statement', None], None]]]"]],
    ],
    "parse — for loop": [
  ...
  const lambdaTests: TestCases = {
    "parse — lambda single param": [
      ['print(parse("lambda x: x"))', null, ["[ 'lambda_expression',\n[ [['name', ['x', None]], None],\n[['return_statement', [['name', ['x', None]], None]], None]]]"]],
    ],
    "parse — lambda multiple params": [
      ['print(parse("lambda x, y: x"))', null, ["[ 'lambda_expression',\n[ [['name', ['x', None]], [['name', ['y', None]], None]],\n[['return_statement', [['name', ['x', None]], None]], None]]]"]],
    ],
    "parse — lambda no params": [
      ['print(parse("lambda: 1"))', null, ["[ 'lambda_expression',\n[None, [['return_statement', [['literal', [1, None]], None]], None]]]"]],
    ],
  };
  ...
  const assignTests: TestCases = {
    "parse — single declaration": [
      ['print(parse("x = 1"))', null, ["['declaration', [['name', ['x', None]], [['literal', [1, None]], None]]]"]],
    ],
  ...
  const listTests: TestCases = {
    "parse — list expression": [
      ['print(parse("[1, 2, 3]"))', null, ["[ 'array_expression',\n[ [['literal', [1, None]], [['literal', [2, None]], [['literal', [3, None]], None]]],\nNone]]"]],
    ],
    "parse — empty list": [
      ['print(parse("[]"))', null, ["['array_expression', [None, None]]"]],
    ],
    "parse — single element list": [
      ['print(parse("[1]"))', null, ["['array_expression', [[['literal', [1, None]], None], None]]"]],
    ],
    "parse — subscript access": [
      ['print(parse("x[0]"))', null, ["['object_access', [['name', ['x', None]], [['literal', [0, None]], None]]]"]],
    ],
  };
  ...
  const controlFlowTests: TestCases = {
    "parse — pass statement": [
      ['print(parse("pass"))', null, ["['pass_statement', None]"]],
    ],
  ...
  const assertTests: TestCases = {
    "parse — assert statement": [
      ['print(parse("assert True"))', null, ["['assert_statement', [['literal', [True, None]], None]]"]],
      ['print(parse("assert 1 == 1"))', null, ["[ 'assert_statement',\n[ ['comparison', ['==', [['literal', [1, None]], [['literal', [1, None]], None]]]],\nNone]]"]],
    ],
  };
  ...
  const importTests: TestCases = {
    "parse — from import single name": [
      ['print(parse("from math import sqrt"))', null, ["['import_from', ['math', [['sqrt', None], None]]]"]],
    ],
    "parse — from import multiple names": [
      ['print(parse("from math import sqrt, cos"))', null, ["['import_from', ['math', [['sqrt', ['cos', None]], None]]]"]],
    ],
  };
