...
\item Comparison, membership and identity tests do not chain:
  \texttt{\textbf{a < b < c}} parses as \texttt{\textbf{(a < b) < c}},
  i.e.\ the result of \texttt{\textbf{a < b}} is compared against
  \texttt{\textbf{c}}, unlike full Python's chained comparisons.
