...
\begin{itemize}
\item \href{https://sourceacademy.org/sicpy/1.1.4\#p8}{\lstinline{math_}$\textit{name}$},
where $\textit{name}$ is any name specified in the
Python
\texttt{\textbf{math}} library, see\\
\href{https://docs.python.org/3.14/library/math.html}{\color{DarkBlue}Python 3.14 Documentation}. Examples:
\begin{itemize}
