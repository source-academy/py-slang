...
values, strings or function values.
Implementations of Source generated error messages when unexpected
...
of \textit{expressions}
matches the number of parameters.

The following table specifies what arguments Python's operators
take and what results they return. Implementations need to check the
