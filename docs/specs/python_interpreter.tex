...
&&                       && |   &\quad && \textbf{\texttt{for}}\ \textit{name}\ \textbf{\texttt{in range}}\ \textit{( range-args ) : block}
                                            && \texttt{linked\_list("for\_loop",  } \langle \textit{range\_args}\rangle \texttt{)} \\
...
&&                       && |   &\quad &&   \textbf{\texttt{[}}\
                                            \textit{expressions}\
                                            \textbf{\texttt{]}}
                                                           && \texttt{linked\_list("list\_expression", literal list of  } \langle \textit{expression}\rangle \texttt{)} \\
