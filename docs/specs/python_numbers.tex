...
A complex value can be formed from a real part and an imaginary part,
...
(e.g., \texttt{3j}) is a numeric literal (an \emph{imaginary literal}),
so \texttt{2+3j} parses as the real literal \texttt{2} combined with
the imaginary literal \texttt{3j} by binary \texttt{+}, and
\texttt{-4.5j} as unary \texttt{-} applied to the imaginary literal
\texttt{4.5j}.
