...
\begin{itemize}
  \item \verb#str#\texttt{(x)}: \textit{primitive},
    converts the value \texttt{x} to a complex number, or a string
  ...
  \item
    \href{https://sourceacademy.org/sicpy/4.1.2\#p2}{\lstinline{is_boolean(x)}},
    \href{https://sourceacademy.org/sicpy/2.3.2\#p5}{\lstinline{is_integer(x)}},
    \href{https://sourceacademy.org/sicpy/2.3.2\#p5}{\lstinline{is_float(x)}},
    \href{https://sourceacademy.org/sicpy/2.3.2\#p7}{\lstinline{is_string(x)}},
    \href{https://sourceacademy.org/sicpy/4.1.2\#p2}{\lstinline{is_none(x)}},
  ...
  \item
    \verb#breakpoint#\texttt{()}: \textit{primitive}, evaluates to the \texttt{None} value with no
    effect on the program (the analogue of JavaScript's \texttt{debugger;} statement). In the stepper
    it additionally marks a breakpoint that the breakpoint navigation can jump to.
  \item
